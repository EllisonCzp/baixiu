    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="email" class="form-control" name="email" type="type" value="czp@czp.me" placeholder="邮箱" readonly>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-6">
            <input id="nickname" class="form-control" name="nickname" type="type" value="czp" placeholder="昵称">
  ...
  <script>
    $(function($) {
      $('#avatar').on('change', function() {
        ...
        // 拿到需要上传的文件
        var file = files[0];
        // FormData 是HTML5 新增的一个成员 专门配合ajax 操作 用于在客户端和服务端之间传递二进制数据
        var date = new FormData();
        date.append('avatar', file);
